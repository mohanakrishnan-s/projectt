...
<html lang="en">
<head>
<title>ATTORNY SCHEDULING </title>
<!-- custom-theme -->
						...
						<div class="shy-menu-panel">
							<nav class="menu menu--horatio link-effect-8" id="link-effect-8">
								<ul class="w3layouts_menu__list">
									...
									<li  class="active"><a href="admin_view_Lawer .php">View Lawer </a></li>
...
<form name="form1" method="post" action="">
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">View Lawer s</h1>
  <p align="center">&nbsp;</p>
  <table width="1040" height="92" border="0" align="center">
    <tr>
    ...
    <?php
	$qry="select * from  advogate_register";
