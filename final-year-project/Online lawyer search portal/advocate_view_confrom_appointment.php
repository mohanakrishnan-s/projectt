...
$qry="select * from    advogate_register where username='$uname'";
$result = mysqli_query($conn, $qry);
$row=mysqli_fetch_assoc($result);
$advogate_type=$row['adv_type'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
						...
						<div class="shy-menu-panel">
							<nav class="menu menu--horatio link-effect-8" id="link-effect-8">
								<ul class="w3layouts_menu__list">
									...
									<li class="active"><a href="advocate_view_confrom_appointment.php">View Confirm Appointments</a></li>
...
<form name="form1" method="post" action="">
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">View Confirm Appointments </h1>
  <p align="center">&nbsp;</p>
  <table width="720" height="100" border="0" align="center">
    ...
    <?php
	$qry="select * from  describe_problem where advogate_type='$advogate_type' and status=1";
	$result = mysqli_query($conn, $qry);
