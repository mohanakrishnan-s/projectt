...
<form name="form1" method="post" action="">
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">View Problems </h1>
  <p align="center">&nbsp;</p>
  <table width="720" height="100" border="0" align="center">
    ...
    <?php
	$qry="select * from  describe_problem where advogate_type='$advogate_type'";
	$result = mysqli_query($conn, $qry);
    ...
    <tr>
	  ...
	  {
	 ?>
	 <a href="advocate_confrom_appointment.php?bid=<?php echo $row['id'];?>&&uid=OK">Appointment</a>
	 <?php
	  }
	  ?></td>
    </tr>
