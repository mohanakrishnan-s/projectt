...
<html lang="en">
<head>
<title>ATTORNEY SCHEDULING System For Case Handling</title>
<!-- custom-theme -->
	...
	<div class="container">
		<div class="banner-logo">
			<a href="#">
				...
				<h1>Lawer  <span>Adviser System</span> </h1>
			</a>
		</div>
	  </div>
						...
						<div class="shy-menu-panel">
							<nav class="menu menu--horatio link-effect-8" id="link-effect-8">
								<ul class="w3layouts_menu__list">
									<li><a href="admin_home.php">Home</a></li>		<li><a href="admin_view_advocate.php">View Lawer </a></li>
									<li  class="active"><a href="admin_view_user.php">View User</a></li>
...
<form name="form1" method="post" action="">
  ...
  <p align="center">&nbsp;</p>
  <table width="765" height="92" border="0" align="center">
    <tr>
...
<div class="wthree_copy_right">
  <div class="container">
		<p>&copy; 2021 Lawer . All rights reserved | Design by <a href="#">Admin</a></p>
