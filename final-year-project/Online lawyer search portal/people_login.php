...
if(isset($_POST['btn'])) 
{
	...
	{
	echo $qry="select * from user_register where uname='$uname' and  pass='$password'";
	...
	alert("login Success");
	window.location.href="people_home.php";
	</script>
	<?php
...
<html lang="en">
<head>
<title>Lawer  Search Portal </title>
<!-- custom-theme -->
	...
	<div class="container">
		<div class="banner-logo">
			<a href="index.html">
				...
				<h1>Lawer  <span>Search Portal</span> </h1>
			</a>
		</div>
	  </div>
						...
						<div class="shy-menu-panel">
							<nav class="menu menu--horatio link-effect-8" id="link-effect-8">
								<ul class="w3layouts_menu__list">
									...
									<li  class="active"><a href="people_login.php">People</a></li>
								</ul>
							</nav>
						</div>
...
<form name="form1" method="post" action="">
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">People Login</h1>
  <p align="center">&nbsp; </p>
  ...
  <p>&nbsp;</p>
  <p align="center"><a href="people_register.php">New People Register</a></p>
  <p>&nbsp;</p>
</form>
<!-- who we are -->
<!-- //who we are -->
