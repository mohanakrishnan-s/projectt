...
$bid=$_REQUEST['bid'];
$uid=$_REQUEST['uid'];
$qry="select * from  advogate_register where id='$bid'";
$result = mysqli_query($conn, $qry);
$row=mysqli_fetch_assoc($result);
$ad_name=$row['name'];
$ad_type=$row['adv_type'];
...
$qrys1="select id from  describe_problem ORDER BY id ASC";
...
$rdate=date("d-m-y");
 ...
 $qrys1="insert into   describe_problem values( $id,'$uname','$ad_name','$ad_type','$bar_council_regno','$ad_contact','$textarea','0','0','0')";
  if ($conn->query($qrys1) === TRUE) {
  ?>					
	<script language="javascript">
	alert("Send Your Request Success");
	window.location.href="people_view_status.php";
	</script>
	<?php
 }
 else
...
<form name="form1" method="post" action="">
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">&nbsp;</h1>
  <h1 align="center">Describe Problem</h1>
  <p align="center">&nbsp;</p>
  <p>&nbsp;</p>
